...
def _resolve_grass_symbols(sym):
    # Add/remove paths depending on your package layout.
...
def test_tree_proximity_map_uses_closest_tree(sym):
    ...
    # Closest tree is at origin => distance=4 => 0.5
    assert m(4.0, 0.0) == pytest.approx(0.5, abs=1e-12)

    # Closest tree is at x=100 => distance=4 => 0.5
