...
def test_viability_layers_are_applied_to_species_viability_map(sym):
    ...
    left = sp.viability_map(5.0, 5.0)    # column ~ 5 
    right = sp.viability_map(30.0, 5.0)  # column ~ 30
...
def test_viability_layers_bias_distribution_over_time(sym):
    """
    Intended integration : terrain viability should bias where plants persist.
